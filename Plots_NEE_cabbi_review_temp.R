...
dev.copy(png,'D:/R/Fluxes/Writeout/Plots/fig2_cflux_over_time_highres.png', width=1350, height=750)
dev.off()
...
#fluxes.gm$lab[fluxes.gm$lab=="mgb"]<-"miscanthus 1"; fluxes.gm$lab[fluxes.gm$lab=="mgc"]<-"miscanthus 2"
fluxes.gm$lab[fluxes.gm$lab=="mgb"]<-"miscanthus 1"; fluxes.gm$lab[fluxes.gm$lab=="mgc"]<-"miscanthus 2"


fluxes<-fluxes.raw
fluxes$lab[fluxes$lab=="zmb"]<-"maize-soy 1"; fluxes$lab[fluxes$lab=="zmc"]<-"maize-soy 2"
fluxes$lab[fluxes$lab=="mgb"]<-"miscanthus 1"; fluxes$lab[fluxes$lab=="mgc"]<-"miscanthus 2"
...
print(paste("all miscanthus mean:", mean(allfluxes$yearseq[allfluxes$lab%in%c("miscanthus 1", "miscanthus 2")])))
print(paste("all miscanthus sd:", sd(allfluxes$yearseq[allfluxes$lab%in%c("miscanthus 1", "miscanthus 2")])))
...
sub<-fluxes[fluxes$lab=="miscanthus 1" & fluxes$year%in%c(2018:2020),]
mean(sub$yearseq); sd(sub$yearseq)

#yield plots, experimental
#plot(yield~year, data=subset(fluxes, lab=="miscanthus 1"), col='blue')
#summary(lm(yield~year, data=subset(fluxes, lab=="miscanthus 1" & year%in%c(2010:2022))))
}

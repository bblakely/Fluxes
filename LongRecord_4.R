...
maize.merge.mod<-maize.2;colnames(maize.merge.mod)[colnames(maize.merge.mod)=="Fco2"]<-"Fc";colnames(maize.merge.mod)[colnames(maize.merge.mod)=="Fco2_Rerr"]<-"Fc_Rerr"
...
maize.c.merge.mod<-maize.c.2; colnames(maize.c.merge.mod)[colnames(maize.c.merge.mod)=="Fco2"]<-"Fc";colnames(maize.c.merge.mod)[colnames(maize.c.merge.mod)=="Fco2_Rerr"]<-"Fc_Rerr"
...
misc.merge.mod<-miscanthus.2; colnames(misc.merge.mod)[colnames(misc.merge.mod)=="Fco2"]<-"Fc";colnames(misc.merge.mod)[colnames(misc.merge.mod)=="Fco2_Rerr"]<-"Fc_Rerr"
...
misc.c.merge.mod<-miscanthus.c.2; colnames(misc.c.merge.mod)[colnames(misc.c.merge.mod)=="Fco2"]<-"Fc"; colnames(misc.c.merge.mod)[colnames(misc.c.merge.mod)=="Fco2_Rerr"]<-"Fc_Rerr"
...
sorg.merge.mod<-sorghum.2; colnames(sorg.merge.mod)[colnames(sorg.merge.mod)=="Fco2"]<-"Fc"; colnames(sorg.merge.mod)[colnames(sorg.merge.mod)=="Fco2_Rerr"]<-"Fc_Rerr"

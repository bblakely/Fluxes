...
write.csv(sorg.print, "Writeout/efarm_sorghum_nosoy.csv", row.names=FALSE)
...
colnames(switch.print)[1:6]<-c("DOY", "mean_cumulative_c_flux_tc_ha-1","standard_deviation", "mean+1sd", "mean-1sd", "num_site_years")
...
write.csv(maize.print, "Writeout/efarm_maize_combined_nosoy.csv", row.names=FALSE)
...
colnames(misc.print)[1:6]<-c("DOY", "mean_cumulative_c_flux_tc_ha-1","standard_deviation", "mean+1sd", "mean-1sd", "num_site_years")
write.csv(misc.print, "Writeout/efarm_miscanthus_combined.csv", row.names=FALSE)
...
#clean it up for carl
soy.print<-soy[soy$doy<366,]#rename and clip off leap day
colnames(soy.print)[1:6]<-c("DOY", "mean_cumulative_c_flux_tc_ha-1","standard_deviation", "mean+1sd", "mean-1sd", "num_site_years")
write.csv(soy.print, "Writeout/efarm_soy_combined.csv", row.names=FALSE)
